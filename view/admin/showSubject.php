...
if (isset($_SESSION['id'])) {
    ...
    $obj = new AddSubject();
    $all = $obj->showSubject($_GET['dpt_id']);
    ?>
    <!DOCTYPE html>
    <html lang="en">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Show Subject</h3></div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Show Subject</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                                            ...
                                            <div class="modal fade" id="exampleModalCenter<?php echo $one->id ?>"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="../../Controller/addSubjectCTRl.php?id=<?php echo $one->id ?>&dpt_id=<?php echo $_GET['dpt_id']?>"
                                                              method="post">
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a class="btn btn-primary btn btn-rounded m-b-10 m-l-5"
                                                               href="../../Controller/addSubjectCTRl.php?sub_id=<?php echo $one->id?>&dpt_id=<?php echo $_GET['dpt_id']?>">YES
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
