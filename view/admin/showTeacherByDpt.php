        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Show Teacher by Department</h3></div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Show Teacher by Department</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                                    ...
                                    <table class="table">
                                        ...
                                        foreach ($allDpt as $one) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-circle btn-outline-primary" href="all_teacher.php?dpt_id=<?php echo $one->id?>"><i
