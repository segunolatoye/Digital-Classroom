        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add Session</h3></div>
                    ...
                    <div class="col-lg-8">
                        <div class="card card-outline-primary">
                            <div class="card-header" style="margin-bottom: 20px">
                                <h4 class="m-b-0 text-white">Add Session</h4>
                            </div>
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="../../Controller/sessionCtrl.php" method="post"
                                    ...
                                    <table class="table">
                                        ...
                                        foreach ($all as $one) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $one->session_name ?></td>
                                                <td>
                                            ...
                                            <div class="modal fade" id="exampleModalCenter<?php echo $one->id ?>"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="../../Controller/sessionCtrl.php?id=<?php echo $one->id ?>"
                                                              method="post">
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control"
                                                                           name="session_name"
                                                                           value="<?php echo $one->session_name ?>">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit"
                                                                ...
                                                                <a href="../../Controller/sessionCtrl.php?s_id=<?php echo $one->id?>">YES</a>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
