            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="card card-outline-primary">
                        ...
                        <div class="card-body">
                            <form action="../../Controller/addDepartmentCTRL.php" method="post">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12 ">
                                ...
                                <table class="table">
                                    ...
                                    <?php $serial=0; foreach ($all as $one){ $serial++?>
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-circle btn-outline-primary" data-toggle="modal" data-target="#exampleModalCenter<?php echo $one->id?>"><i class="fa fa-pencil" style="font-size: large"></i></button>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLongTitle">Edit Department Name</h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    </div>
                                                    <form action="../../Controller/addDepartmentCTRL.php?id=<?php echo $one->id ?>"
                                                          method="post">
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" name="dpt_name"
                                                                       value="<?php echo $one->dpt_name ?>">
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit"
                                                            ...
                                                            <a href="../../Controller/addDepartmentCTRL.php?dpt_id=<?php echo $one->id?>">YES</a>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
