                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 100px">
                                                    ...
                                                    <button class="btn btn-circle btn-outline-danger"
                                                            data-toggle="modal"
                                                            data-target="#MyModal<?php echo $onesublec->id ?>"><i
                                                                class="fa fa-trash-o" style="font-size: large"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                            <div id="MyModal<?php echo $onesublec->id ?>" class="modal fade"
                                                 role="dialog">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit"
                                                                    class="btn btn-primary btn-rounded m-b-10 m-l-5"><a
                                                                        href="../../Controller/lecture.php?id=<?php echo $onesublec->id ?>">YES</a>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
