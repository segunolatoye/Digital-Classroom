                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-two">
                                    <header>
                                        <div class="avatar">
                                            <img src="<?php echo base_url ?>upload/image/<?php echo $all['photo'] ?>"
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-xs-6"><strong>Teacher Id</strong>
                                                <br>
                                                <p class="text-muted"><?php echo $all['teacher_id'] ?></p>
                                            </div>
                                            <div class="col-md-3 col-xs-6 b-r"><strong>Department</strong>
                                                <br>
                                                <p class="text-muted"><?php echo $all['dpt_name'] ?></p>
                                            </div>
                                            <div class="col-md-3 col-xs-6 b-r"><strong>Mobile</strong>
                                                <br>
                                                <p class="text-muted"><?php echo $all['mobile'] ?></p>
                                            </div>
                                ...
                                <div class="tab-pane" id="settings" role="tabpanel">
                                    <div class="card-body">
                                        <form class="form-horizontal form-material"
                                              action="../../Controller/dptHeadUpdateCtrl.php" method="post"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <textarea class="form-control form-control-line" id="info"
                                                              name="info"
                                                              disabled><?php echo $all['info'] ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="file" class="form-control" style="width: 100%"
                                                           ...
                                                           value="<?php echo $all['image'] ?>" hidden>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-sm-12">
