                            ...
                            <div class="content col-lg-12">
                                ...
                                <div class="lectures col-lg-12" style="min-height: 60vh">
                                    ...
                                    foreach ($alllecbysub as $singlelec) {
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="options col-lg-2">
                                                            ...
                                                            <span><a href="<?php echo base_url ?>upload/<?php echo $singlelec['lec_file'] ?>"
                                                                     target="_blank">Click Here To Show Details</a></span><br>

                                                            <!--<button style="height: 30px" class="btn btn-square btn-outline-danger"
                                                                    data-toggle="modal"
                                                                    data-target="#MyModal<?php /*echo $singlelec['id'] */?>"><i
                                        ...
                                        <div id="MyModal<?php echo $singlelec['id'] ?>" class="modal fade"
                                             role="dialog">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button
                                                                class="btn btn-primary btn-rounded m-b-10 m-l-5"><a
                                                                    href="../../Controller/lecture.php?id=<?php echo $singlelec['id'] ?>&sub_id=<?php echo $_GET['id']?>">YES</a>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
