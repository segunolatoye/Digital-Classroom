                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-subtitle">
                            <h4>Select for call attendence</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <table id="myTable" class="table table-bordered table-striped">
                                    ...
                                    foreach ($allBatch as $batch) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="std_details.php?s=<?php echo $batch['subject_id']?>&d=<?php echo $batch['dpt_id']?>&b=<?php echo $batch['batch_id']?>&ssn=<?php echo $batch['session_id']?>"
