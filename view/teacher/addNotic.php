                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="post" action="../../Controller/addNotic.php"
                                    ...
                                    <div class="form-group">
                                        <textarea required class="textarea_editor form-control" rows="15" name="notic"
                                                  placeholder="Enter text ..." style="height:450px"></textarea>
                                    </div>
                                    <div class="row">
                                        <div class="col-3">
                                            <div class="form-group">
                                                <label>As Department </label>
                                                <select class="form-control" id="val-skill" name="dpt_id" required>
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <label>As Batch </label>
                                                <select class="form-control" id="val-skill" name="batch_id" required>
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <label>As Session </label>
                                                <select class="form-control" id="val-skill" name="session_id" required>
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <label>As Subject </label>
                                                <select class="form-control" id="val-skill" name="subject_id" required>
