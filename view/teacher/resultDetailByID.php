...
if (isset($_SESSION['id'])) {
                                    ...
                                    <table id="example23" class="table table-bordered table-striped">
                                        ...
                                        foreach ($allRslt as $rslt) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button id="<?php echo $rslt->id ?>" onclick="upd_set(this)"
            ...
            <div class="modal-content">
                ...
                <form action="../../Controller/resultCtrl.php" method="post">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <label for="mid">CT Mark</label>
                                <input id="ct" name="ct_mrk" type="text" class="form-control input-rounded success">
                            </div>
                            <div class="col-md-6">
                                <label for="fnl">Assignment Mark</label>
                                <input id="ass" name="ass_mrk" type="text" class="form-control input-rounded success">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
    ...
    <script>
        function upd_set(e) {
            ...
            document.getElementById("ct").value = table.rows[row].cells[3].innerHTML;
            document.getElementById("ass").value = table.rows[row].cells[4].innerHTML;
            document.getElementById("mid").value = table.rows[row].cells[5].innerHTML;
            document.getElementById("fnl").value = table.rows[row].cells[6].innerHTML;
